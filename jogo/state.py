...
class Scene(State):
    def __init__(self, game):
        ...
        self.draw_sprite = pygame.sprite.Group()
        
        self.player = Player(self.game, self, [self.update_sprites, self.draw_sprite],(WIDTH/2, HEIGHT/2), 'player')
